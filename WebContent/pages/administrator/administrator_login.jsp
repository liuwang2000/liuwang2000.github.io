...
<html>
  ...
  if(cookies!=null)
   ...
   %>
   <div id="top"><img src="../../images/base.png" style="height: 99px; width: 102px; ">天天见收银系统 </div>
   <hr size="2px" color="#5B5B5B"/>
    <form action="/ttjsyxt/servlet/masterLogin" method="post" onsubmit="return resub();">
    	...
    	<table align="left">
    		...
    		<tr>
    			...
    			onMouseOver="this.style.backgroundImage='url(../../images/zfjg.png)'" 
